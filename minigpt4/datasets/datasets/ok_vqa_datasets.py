...
class OKVQADataset(VQADataset, DisplMixin):
    ...
    def get_data(self, index):
        ...
        answer = random.choices(answers, weights, k=1)[0]
...
class OKVQGDataset(OKVQADataset):
    ...
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        ...
        self.instruction_pool = [
            ...
            'Taking the image into account, generate a question that has the answer: {}'
        ]
